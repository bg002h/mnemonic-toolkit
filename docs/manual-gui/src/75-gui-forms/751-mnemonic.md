...
```{.text include="gui/mnemonic-addresses.gui"}
...
```{.text include="gui/mnemonic-convert.gui"}
(structural form render — generated from the pinned renderer at build time)
```
...
```{.text include="gui/mnemonic-export-wallet.gui"}
(structural form render — generated from the pinned renderer at build time)
```
...
```{.text include="gui/mnemonic-gen-man.gui"}
(structural form render — generated from the pinned renderer at build time)
```
...
```{.text include="gui/mnemonic-inspect.gui"}
(structural form render — generated from the pinned renderer at build time)
```
...
```{.text include="gui/mnemonic-ms-shares-split.gui"}
(structural form render — generated from the pinned renderer at build time)
```
...
```{.text include="gui/mnemonic-repair.gui"}
(structural form render — generated from the pinned renderer at build time)
```
...
```{.text include="gui/mnemonic-seedqr-decode.gui"}
(structural form render — generated from the pinned renderer at build time)
```
...
```{.text include="gui/mnemonic-silent-payment.gui"}
(structural form render — generated from the pinned renderer at build time)
```
...
```{.text include="gui/mnemonic-slip39-split.gui"}
(structural form render — generated from the pinned renderer at build time)
```
...
```{.text include="gui/mnemonic-verify-message.gui"}
(structural form render — generated from the pinned renderer at build time)
```
...
```{.text include="gui/mnemonic-xpub-search-path-of-xpub.gui"}
(structural form render — generated from the pinned renderer at build time)
```
