...
## `md compose` {#gui-form-md-compose}

![md compose — GUI form screenshot (dark theme, 2x)](../../figures/gui/md-compose.png)

Structural render of the `md compose` form — every flag and positional with its control kind and on-load default value (secret fields masked).

```{.text include="gui/md-compose.gui"}
(structural form render — generated from the pinned renderer at build time)
```
...
## `md decompose` {#gui-form-md-decompose}

![md decompose — GUI form screenshot (dark theme, 2x)](../../figures/gui/md-decompose.png)

Structural render of the `md decompose` form — every flag and positional with its control kind and on-load default value (secret fields masked).

```{.text include="gui/md-decompose.gui"}
(structural form render — generated from the pinned renderer at build time)
```

## `md descriptor` {#gui-form-md-descriptor}

![md descriptor — GUI form screenshot (dark theme, 2x)](../../figures/gui/md-descriptor.png)

Structural render of the `md descriptor` form — every flag and positional with its control kind and on-load default value (secret fields masked).

```{.text include="gui/md-descriptor.gui"}
(structural form render — generated from the pinned renderer at build time)
```
...
## `md shape-key` {#gui-form-md-shape-key}

![md shape-key — GUI form screenshot (dark theme, 2x)](../../figures/gui/md-shape-key.png)

Structural render of the `md shape-key` form — every flag and positional with its control kind and on-load default value (secret fields masked).

```{.text include="gui/md-shape-key.gui"}
(structural form render — generated from the pinned renderer at build time)
```
