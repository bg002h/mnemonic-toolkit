...
The m-format constellation\index{m-format constellation} answers a specific question: *how do you durably back up a Bitcoin self-custody wallet on engravable media, in a form that survives decades of physical decay and human transcription error?*
