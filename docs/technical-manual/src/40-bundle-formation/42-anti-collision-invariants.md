...
| ms1, mk1 | 20 | 5 | `derive_mk1_chunk_set_id(policy_id[0..4])` packed as `((b0 << 12) \| (b1 << 4) \| (b2 >> 4))` | `synthesize.rs::derive_mk1_chunk_set_id` formats via `bundle.rs::build_unified_card` |
