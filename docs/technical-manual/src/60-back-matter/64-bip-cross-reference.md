...
|---|---|---|
| BIP-32 | Hierarchical Deterministic Wallets | §I.1, §I.2, §I.3, §I.4, §II.1, §II.2, §II.3, §III.1, §III.3, §IV.2 |
| BIP-39 | Mnemonic code for generating deterministic keys | §I.1, §I.2, §II.3, §IV.1, §IV.2, §IV.3 |
...
| BIP-93 | codex32 — Checksummed SSSS-aware BIP-32 seeds | §I.2, §I.3, §I.4, §II.2, §II.3, §IV.3 |
