...
|---|---|---|
| BIP-32 | Hierarchical Deterministic Wallets | §I.1, §I.2, §I.3, §I.4, §II.1, §II.2, §II.3 |
| BIP-39 | Mnemonic code for generating deterministic keys | §I.1, §I.2, §II.3 |
| BIP-48 | Multi-Script Hierarchy for Multi-Sig Wallets | §II.2 |
| BIP-84 | Derivation scheme for P2WPKH based accounts | §I.1, §I.2, §II.2 |
...
| BIP-341 | Taproot: SegWit version 1 spending rules | §II.1 |
| BIP-342 | Validation of Taproot Scripts (tapscript) | §II.1 |
| BIP-380 | Output Script Descriptors General Operation | §II.2 |
| BIP-388 | Wallet Policies for Descriptor Wallets | §I.1, §I.2, §I.3, §I.4, §II.1 |
| BIP-389 | Multipath Descriptor Key Expressions | §I.4, §II.1 |
