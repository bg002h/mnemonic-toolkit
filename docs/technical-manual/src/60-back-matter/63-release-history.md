...
| 2026-05-11 | `tech-manual-v0.4.0` | Part V (Rust API reference: md-codec, mk-codec, ms-codec, mnemonic-toolkit) added; back-matter accreted (glossary ≥93 entries, index ≥488 rows, BIP cross-reference broadened across Part V citations); PDF pending Phase 4.7. |
