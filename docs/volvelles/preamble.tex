...
% \volvellecellinnermost{<bech32-char>}: ~40% of regular (~60% of inner).
% Used for row 0 only — radius is smallest there, so the 32 cells must be
% squeezed into the tightest arc.
\newcommand{\volvellecellinnermost}[1]{\textsf{\fontsize{2.4}{3}\selectfont #1}}
