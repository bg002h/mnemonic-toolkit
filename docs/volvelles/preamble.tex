...
\usepackage[letterpaper, margin=0.05in, nohead, nofoot]{geometry}
\usepackage{fontspec}
\usepackage{tikz}
...
% \volvellecellinnermost{<bech32-char>}: aliased to \volvellecellinner
% (3.6pt) for legibility per user-feedback in the v0.1.4 cycle. The
% prior 2.4pt size proved hard to read on home printers; the +14%
% diameter bump in v0.1.4 widens row-0 arc length enough that 3.6pt
% fits without crowding.
\newcommand{\volvellecellinnermost}[1]{\volvellecellinner{#1}}
