...
| G5 — Refusal coverage | All 24 refusal classes (§2.5; row 24 added at v0.13.0 P2.2 GREEN per Q3 fold) have CLI tests asserting exit code 1 + pinned stderr stem. The 30 negative vectors from G1 are exercised at the lib layer; CLI-level tests verify each stem surfaces byte-faithfully. |
