...
- **This repo's verified findings (23):**
  ...
  - **[obs]** `anti-collision-16bit-invariant-false` — The manual documents that the leading 16 bits of chunk_set_id agree across all three cards from one bundle. In reality md1's csi = derive_chunk_set_id(compute_md1_encoding_id(d)) (the ENCODING id), mk (`crates/mnemonic-toolkit/CHANGELOG.md:1899 (technical-manual §IV.2); md-codec chunk.rs:242-244; toolkit synthesize.rs:260,278; ms-codec encode.rs:16`)
...
### `cell-27-verify-bundle-auto-fire-tty-flaky-on-macos` — auto-repair TTY cell flakes on the macos runner (empty temp bundle-json)
