...
- **Companion:** `mnemonic-gui` — see `gui-build-descriptor-schema-mirror-pending-pin-bump` below (the schema-mirror lockstep + the eventual GUI wizard consuming `--spec-schema`).
