...
- **Where:** `crates/mnemonic-toolkit/src/cmd/verify_bundle.rs::descriptor_mode_verify_run` mk1-card-supplied parsing path; `crates/mnemonic-toolkit/src/cmd/verify_bundle.rs::bundle_json_intake` (the `--bundle-json` envelope reader for v0.4.3+).
