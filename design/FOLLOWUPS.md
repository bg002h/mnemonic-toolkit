...
- **This repo's verified findings (23):**
  ...
  - **[obs]** `silentpayment-phrase-english-only` — resolve_master_xpriv parses a raw BIP-39 phrase with bip39::Language::English unconditionally (line 155), while the ms1 branch (lines 138-141) correctly resolves per-card wire language via payload_bip (`crates/mnemonic-toolkit/src/cmd/silent_payment.rs:154-156`)
