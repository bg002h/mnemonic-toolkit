...
- **What:** reword the entry to the current default (`0`/genesis-rescan) + the `TimestampArgValue` type. Prose-only; the symbol-pin/qualification cycles pin *locations*, not *claims* (claim re-validation is the api-harvest class). Trivial.
- **Status:** `open`
- **Tier:** `v0.22+-doc-hygiene`
- **Companion:** none.
