...
- **This repo's verified findings (23):**
  ...
  - **[minor]** `import-json-schema-version-unchecked` — The import-json envelope carries schema_version (outer "1", inner bundle "4") into deserialized String fields, but no consumer reads or version-gates it. serde drops unknown fields by default, so a fu (`crates/mnemonic-toolkit/src/wallet_import/json_envelope.rs:62-90 (ImportJsonEnvelope), :149-170 (BundleJsonView); consumers cmd/export_wallet.rs:619 run_from_import_json, cmd/bundle.rs:1716 bundle_run_from_import_json`)
  ...
  - **[minor]** `silentpayment-nostr-priv-not-zeroizing` — scan_priv/spend_priv (silent_payment.rs:256-257 = hex::encode of the derived scan/spend secret bytes) and the nostr WIF (nostr.rs:212 wif_for) are plain String values carried into JSON envelope struct (`crates/mnemonic-toolkit/src/cmd/silent_payment.rs:256-257,271-272,97-98; crates/mnemonic-toolkit/src/cmd/nostr.rs:212,221,231,249`)
