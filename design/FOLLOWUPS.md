...
- **Status:** open
- **Tier:** next-cycle (cross-repo; follows the per-key use-site override cycle).
- **Companion:** `descriptor-mnemonic/design/FOLLOWUPS.md::sortedmulti-a-derive-gap-fenced` (the md-codec `sortedmulti_a` render-gap leg).
