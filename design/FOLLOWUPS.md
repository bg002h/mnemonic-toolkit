...
### `display-grouping-render-strip-v1` — standardized mstring display-grouping across the constellation (toolkit + 3 sibling CLIs + GUI)
...
- **Status:** P1-P3 released; P4 shipping; **P5 (GUI) open**. Sibling companions filed: descriptor-mnemonic / mnemonic-secret / mnemonic-key `design/FOLLOWUPS.md` (`display-grouping-render-strip-v1`).
- **Tier:** `cross-repo`.
