...
- **Companions (mirrored):** `mnemonic-secret/design/FOLLOWUPS.md::ms1-envelope-uppercase-bip173` (envelope case-normalize per BIP-173 → then a toolkit pin bump flips the uppercase-ms1 leg green); spawned here: `friendly-ms1-invalidchecksum-echoes-full-input` (below).
- **Tier:** resolved.
