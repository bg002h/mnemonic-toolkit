...
- **This repo's verified findings (23):**
  ...
  - **[obs]** `self-check-header-claims-unread-vector` — The module doc states fixtures live at tests/vectors/v0_2/{bip84,wsh-sortedmulti}-mainnet-0-false-true.txt, implying both are exercised. The code only reads the bip84 one. wsh-sortedmulti-mainnet-0-fa (`crates/mnemonic-toolkit/tests/cli_self_check.rs:5 vs :13`)
