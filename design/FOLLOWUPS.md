...
- **Status:** open — deferred from Release A; design the per-variant opt-out + the loud-banner UX (a reviewed unsafe emit, never silent).
- **Tier:** `v0.52+-feature`.
- **Companion:** none.
