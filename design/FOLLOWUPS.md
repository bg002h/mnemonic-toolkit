...
### `restore-non-nums-taproot-internal-key` — ✓ RESOLVED (v0.55.3 (pending tag), 2026-06-13) — `restore --md1` reconstructs a non-NUMS ("real key at the trunk") taproot wallet-policy card
