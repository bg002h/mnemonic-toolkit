...
#[test]
fn bsms_refuses_coldcard() {
    assert_format_mismatch("bsms", "coldcard-singlesig-bip84-mainnet.json", "coldcard");
}
#[test]
fn bsms_refuses_coldcard_multisig() {
    assert_format_mismatch(
        "bsms",
        "coldcard-ms-2of3-p2wsh-with-xfp.txt",
        "coldcard-multisig",
    );
}
#[test]
fn bsms_refuses_electrum() {
    assert_format_mismatch("bsms", "electrum-standard-bip84-mainnet.json", "electrum");
}
#[test]
fn bsms_refuses_jade() {
    assert_format_mismatch("bsms", "jade-multisig-2of3-p2wsh.json", "jade");
}
#[test]
fn bsms_refuses_sparrow() {
    assert_format_mismatch("bsms", "sparrow-singlesig-p2wpkh.json", "sparrow");
}
#[test]
fn bsms_refuses_specter() {
    assert_format_mismatch("bsms", "specter-singlesig-p2wpkh.json", "specter");
}

// BitcoinCore arm — symmetric (6 new refusals).
#[test]
fn bitcoin_core_refuses_coldcard() {
    assert_format_mismatch(
        "bitcoin-core",
        "coldcard-singlesig-bip84-mainnet.json",
        "coldcard",
    );
}
#[test]
fn bitcoin_core_refuses_coldcard_multisig() {
    assert_format_mismatch(
        "bitcoin-core",
        "coldcard-ms-2of3-p2wsh-with-xfp.txt",
        "coldcard-multisig",
...
#[test]
fn bitcoin_core_refuses_electrum() {
    assert_format_mismatch(
        "bitcoin-core",
        "electrum-standard-bip84-mainnet.json",
        "electrum",
    );
}
#[test]
fn bitcoin_core_refuses_jade() {
    assert_format_mismatch("bitcoin-core", "jade-multisig-2of3-p2wsh.json", "jade");
}
#[test]
fn bitcoin_core_refuses_sparrow() {
    assert_format_mismatch("bitcoin-core", "sparrow-singlesig-p2wpkh.json", "sparrow");
}
#[test]
fn bitcoin_core_refuses_specter() {
    assert_format_mismatch("bitcoin-core", "specter-singlesig-p2wpkh.json", "specter");
}

// ColdcardMultisig arm — 5 new refusals.
#[test]
fn coldcard_multisig_refuses_coldcard() {
    assert_format_mismatch(
        "coldcard-multisig",
        "coldcard-singlesig-bip84-mainnet.json",
        "coldcard",
...
#[test]
fn coldcard_multisig_refuses_electrum() {
    assert_format_mismatch(
        "coldcard-multisig",
        "electrum-standard-bip84-mainnet.json",
        "electrum",
...
#[test]
fn coldcard_multisig_refuses_jade() {
    assert_format_mismatch("coldcard-multisig", "jade-multisig-2of3-p2wsh.json", "jade");
}
#[test]
fn coldcard_multisig_refuses_sparrow() {
    assert_format_mismatch(
        "coldcard-multisig",
        "sparrow-singlesig-p2wpkh.json",
        "sparrow",
    );
}
#[test]
fn coldcard_multisig_refuses_specter() {
    assert_format_mismatch(
        "coldcard-multisig",
        "specter-singlesig-p2wpkh.json",
        "specter",
    );
}
...
#[test]
fn coldcard_refuses_jade() {
    assert_format_mismatch("coldcard", "jade-multisig-2of3-p2wsh.json", "jade");
}

// Electrum arm — 1 new refusal.
#[test]
fn electrum_refuses_jade() {
    assert_format_mismatch("electrum", "jade-multisig-2of3-p2wsh.json", "jade");
}

// Sparrow arm — 4 new refusals.
#[test]
fn sparrow_refuses_coldcard() {
    assert_format_mismatch(
        "sparrow",
        "coldcard-singlesig-bip84-mainnet.json",
        "coldcard",
...
#[test]
fn sparrow_refuses_jade() {
    assert_format_mismatch("sparrow", "jade-multisig-2of3-p2wsh.json", "jade");
}
#[test]
fn sparrow_refuses_specter() {
    assert_format_mismatch("sparrow", "specter-singlesig-p2wpkh.json", "specter");
}

// Specter arm — 3 new refusals.
#[test]
fn specter_refuses_coldcard() {
    assert_format_mismatch(
        "specter",
        "coldcard-singlesig-bip84-mainnet.json",
        "coldcard",
...
#[test]
fn specter_refuses_jade() {
    assert_format_mismatch("specter", "jade-multisig-2of3-p2wsh.json", "jade");
}
