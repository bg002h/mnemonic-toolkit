...
subtitle: "mnemonic-toolkit v0.103.2 -- worked examples (Linux), exact verbatim I/O"
date: "2026-07-05"
...
`mnemonic` **v0.103.2** on Linux and **both the command and its full output are
...
md              md-cli               crates.io    cli-compiler   descriptor-mnemonic-md-cli-v0.19.0
...
install  mnemonic (git: mnemonic-toolkit-v0.103.2)
  [dry-run] cargo install --locked --git https://github.com/bg002h/mnemonic-toolkit --tag mnemonic-toolkit-v0.103.2   mnemonic-toolkit
...
with `mnemonic` v0.103.2 on Linux. See the in-repo manual (`docs/manual/`) for
...
as of v0.103.2** and everything below is live-captured from the shipped
