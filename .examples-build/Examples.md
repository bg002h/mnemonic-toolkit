...
subtitle: "mnemonic-toolkit v0.77.0 -- worked examples (Linux), exact verbatim I/O"
date: "2026-07-05"
...
`mnemonic` **v0.77.0** on Linux and **both the command and its full output are
...
---------       -------------        -------      --------       -------
mnemonic        mnemonic-toolkit     git (only)   (none)         mnemonic-toolkit-v0.77.0
...
install  mnemonic (git: mnemonic-toolkit-v0.77.0)
  [dry-run] cargo install --locked --git https://github.com/bg002h/mnemonic-toolkit --tag mnemonic-toolkit-v0.77.0   mnemonic-toolkit
...
with `mnemonic` v0.77.0 on Linux. See the in-repo manual (`docs/manual/`) for
...
> `mnemonic` v0.77.0 documented everywhere else in this guide deliberately
