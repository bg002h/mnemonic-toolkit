...
ANCHORS = [
    ...
    ("verify call site", V, r"let outcome = complete_multisig_template"),
    ...
    ("retired test 1", TT, r"fn floor_weak_id_prefix_refuses"),
    ("retired test 2", TT, r"fn own_account_max_short_id_prefix_refuses"),
    ("retired test 3", TT, r"fn search_cosigner_subset_weak_prefix_refuses"),
...
CITED = {
    "the +32 rationale": "permutation_search.rs:311",
    "AMBIGUOUS arm": "restore.rs:2148",
    "odd-hex decode": "restore.rs:2519",
    "per-thread collection": "permutation_search.rs:1085-1087",
    "sortedmulti id note": "restore.rs:1957-1959",
    "cost calibration": "restore.rs:2295",
    "prefix validation": "restore.rs:2034",
    "the dispatch": "restore.rs:2030",
    "id_search is_some": "restore.rs:1949",
    "addr_search is_some": "restore.rs:1950",
    "PrefixTooShort mapping": "restore.rs:2250",
    "exit code 4": "error.rs:656",
    "the shared engine": "restore.rs:1472",
    "the outcome type": "restore.rs:1207",
    "verify call site": "verify_bundle.rs:954",
    "verify passes the flag": "verify_bundle.rs:946",
    "the single emitter": "restore.rs:2435",
    "@N= early return": "restore.rs:1793",
    "--count flag": "restore.rs:220",
    "ceiling to bad": "restore.rs:2256",
    "sortedmulti shape flag": "restore.rs:1960",
    "Enumeration::n": "permutation_search.rs:848",
    "Enumeration::cardinality": "permutation_search.rs:862",
    "the determinism oracle": "permutation_search.rs:1128",
    "id-path address_index is 0": "permutation_search.rs:1066",
    "bare-xpub decode": "restore.rs:2186-2188",
    "retired test 1": "cli_restore_md1_template_multisig.rs:637",
    "retired test 2": "cli_restore_md1_template_multisig.rs:1044",
    "retired test 3": "cli_restore_md1_template_multisig.rs:1296",
    "retired unit test": "permutation_search.rs:1241",
}
