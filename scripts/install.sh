...
component_info() {
    case "$1" in
        mnemonic)
            echo "mnemonic-toolkit|https://github.com/bg002h/mnemonic-toolkit|mnemonic-toolkit-v0.90.0|no|"
            ;;
        md)
            echo "md-cli|https://github.com/bg002h/descriptor-mnemonic|descriptor-mnemonic-md-cli-v0.11.2|yes|cli-compiler"
            ;;
        ms)
            echo "ms-cli|https://github.com/bg002h/mnemonic-secret|ms-cli-v0.14.1|yes|"
            ;;
        mk)
