...
component_info() {
    case "$1" in
        mnemonic)
            echo "mnemonic-toolkit|https://github.com/bg002h/mnemonic-toolkit|mnemonic-toolkit-v0.60.0|no|"
            ;;
        md)
            echo "md-cli|https://github.com/bg002h/descriptor-mnemonic|descriptor-mnemonic-md-cli-v0.7.1|yes|cli-compiler"
            ;;
        ms)
            echo "ms-cli|https://github.com/bg002h/mnemonic-secret|ms-cli-v0.7.0|yes|"
            ;;
        mk)
            echo "mk-cli|https://github.com/bg002h/mnemonic-key|mk-cli-v0.8.0|yes|"
            ;;
        mnemonic-gui)
            echo "mnemonic-gui|https://github.com/bg002h/mnemonic-gui|mnemonic-gui-v0.40.0|no|"
            ;;
        *)
            return 1
            ;;
